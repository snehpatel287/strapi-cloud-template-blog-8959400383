...
const ListView$1 = lazy(() => import("./ListView-jhsuW3hn.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-jhsuW3hn.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-FXx8jIJw.mjs.map
