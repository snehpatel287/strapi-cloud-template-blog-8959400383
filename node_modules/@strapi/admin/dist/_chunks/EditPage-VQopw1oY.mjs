...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-8fMH5B2m.mjs";
...
import { u as useWebhooks } from "./useWebhooks-_HQT8wod.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable--BZ2g3rl.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-VQopw1oY.mjs.map
